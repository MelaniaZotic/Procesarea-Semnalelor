...
frecventa_initiala = 5
amplitudine_initiala = 1
faza_initiala = 0
durata_semnal = 1
frecventa_esantionare_noua = 20  # Modificare a ratei de eșantionare

# Generare semnal inițial cu noua frecvență de eșantionare
timp_nou, semnal_inițial_nou = generare_semnal(frecventa_initiala, amplitudine_initiala, faza_initiala, durata_semnal,
                                               frecventa_esantionare_noua)

# Eșantionare semnal inițial cu noua frecvență de eșantionare
timp_eșantionat_nou = eșantionare(frecventa_esantionare_noua, durata_semnal)

# Generare alte două semnale cu frecvențe diferite
frecventa_2 = 2
frecventa_3 = 8
_, semnal_2_nou = generare_semnal(frecventa_2, amplitudine_initiala, faza_initiala, durata_semnal,
                                  frecventa_esantionare_noua)
_, semnal_3_nou = generare_semnal(frecventa_3, amplitudine_initiala, faza_initiala, durata_semnal,
                                  frecventa_esantionare_noua)
...
plt.subplot(3, 1, 2)
plt.plot(timp_eșantionat_nou, semnal_2_nou,
         label=f'Semnal {frecventa_2} Hz eșantionat cu noua frecvență de eșantionare')
plt.title(f'Semnal {frecventa_2} Hz eșantionat cu noua frecvență de eșantionare')

plt.subplot(3, 1, 3)
plt.plot(timp_eșantionat_nou, semnal_3_nou,
         label=f'Semnal {frecventa_3} Hz eșantionat cu noua frecvență de eșantionare')
